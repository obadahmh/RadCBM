...
\midrule
U-Ignore (default) & 0.5265 \\
U-Zero & 0.5259 \\
\bottomrule
\end{tabular}
\end{table}

We find that treating uncertain disease labels as missing (U-Ignore) is not sensitive to this choice: on the CheXpert Plus expert subset, U-Zero changes macro AUC by less than 0.001.
