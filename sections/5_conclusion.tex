...
First, the current vocabulary focuses on chest radiography; extending the concept hierarchy and extraction pipeline to other modalities (for example, CT and MRI) and multi-view studies will be important for broader clinical impact.
