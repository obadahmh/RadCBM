...
Entities are normalized to canonical RadLex or UMLS terms using a lexicon and string-similarity matcher, and only clinically meaningful semantic types are kept: imaging observations, clinical findings, pathophysiologic processes, and chest anatomy.
