...
\radcbm\ & H-CBM & 0.76 & 0.75 & 0.73 & 0.85 & 0.87 & 0.790 \\
\midrule
...
CXR-CLIP (Swin-T) & VLM & \placeholder{.XXX} & \placeholder{.XXX} & \placeholder{.XXX} & \placeholder{.XXX} & \placeholder{.XXX} \\
CheXzero (ViT-B/32) & VLM & \placeholder{.XXX} & \placeholder{.XXX} & \placeholder{.XXX} & \placeholder{.XXX} & \placeholder{.XXX} \\
\midrule
