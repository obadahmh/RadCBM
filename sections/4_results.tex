...
This procedure yields a vocabulary of several hundred region-specific concepts that together cover common thoracic pathologies and a substantial portion of the clinical long tail.
...
Classification AUC matches the black-box CNN within the variance of cross-validation while exposing a linear map from concepts to labels, showing that enforcing a concept bottleneck and anatomy-first structure does not materially degrade diagnostic performance.
