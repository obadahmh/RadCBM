\begin{abstract}
    Abstract to be written towards the end\ldots
...
% We extract concepts with RadGraph, normalize them to SNOMED CT identifiers within the UMLS, filter to clinically meaningful semantic types, and organize them into anatomy-level regions.
